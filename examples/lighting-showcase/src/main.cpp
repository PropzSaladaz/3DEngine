...
void MyApp::createMeshes() {
    ...
    meshes->import("light", "models/sphere.obj");
    meshes->import("statue", "models/statue.obj");
    meshes->import("wood-base", "models/base.obj");
    meshes->import("glass", "models/dome3.obj");
}
...
void MyApp::createShaderPrograms() {
    ...
    statueShaders->addShader(GL_VERTEX_SHADER, "shaders/vertexShader.glsl");
    statueShaders->addShader(GL_FRAGMENT_SHADER, "shaders/light/statue.glsl");
    ...
    woodShaders->addShader(GL_VERTEX_SHADER, "shaders/vertexShader.glsl");
    woodShaders->addShader(GL_FRAGMENT_SHADER, "shaders/light/statue.glsl");
    ...
    glassFrontShaders->addShader(GL_VERTEX_SHADER, "shaders/vertexShader.glsl");
    glassFrontShaders->addShader(GL_FRAGMENT_SHADER, "shaders/light/glass-front.glsl");
    ...
    glassBackShaders->addShader(GL_VERTEX_SHADER, "shaders/vertexShader.glsl");
    glassBackShaders->addShader(GL_FRAGMENT_SHADER, "shaders/light/glass-back.glsl");
    ...
    lightShaders->addShader(GL_VERTEX_SHADER, "shaders/vertexShader.glsl");
    lightShaders->addShader(GL_FRAGMENT_SHADER, "shaders/light/basic-color-fs.glsl");
...
void MyApp::createSceneGraph() {
    ...
    Scene->setSkybox("textures/cubemaps/bedroom/", "png");
